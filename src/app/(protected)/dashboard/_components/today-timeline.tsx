  ...
  return (
    <Card className="relative overflow-hidden border-border/60 shadow-sm flex flex-col min-h-[600px]">
      ...
      <CardContent className="pt-0 flex-1 flex flex-col">
        {data.length === 0 ? (
          <div className="flex flex-col items-center -translate-y-8 justify-center flex-1 text-center text-muted-foreground w-full">
              ...
              >
                ...
                <div className="min-w-0 flex-1 flex items-center justify-between gap-2">
                  <div className="min-w-0">
                    <span
                      className={`text-sm font-medium truncate ${isCancelled ? "line-through text-muted-foreground" : ""}`}
                    >
                      {session.studentName}
                    </span>
                  </div>
